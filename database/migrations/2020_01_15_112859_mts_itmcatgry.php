...
class MtsItmcatgry extends Migration
{
    ...
    public function up()
    {
        Schema::create('mtsitmcatgry', function (Blueprint $table) {
            ...
            $table->smallInteger('Catg_No')->nullable();
            $table->bigInteger('Parnet_Catg')->nullable();
            $table->smallInteger('Level_Status')->nullable();
            $table->smallInteger('Level_No')->nullable();
            $table->smallInteger('Catg_Active')->nullable();
            $table->string('Catg_NmAr', 20)->nullable();
            $table->string('Catg_NmEn', 20)->nullable();
