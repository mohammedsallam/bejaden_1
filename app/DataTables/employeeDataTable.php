...
class employeeDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('edit', function ($query) {
                return '<a href="employees/'.$query->id.'/edit" class="btn btn-success edit"><i class="fa fa-edit"></i> ' . trans('admin.edit') . '</a>';
            })
    ...
    protected function getColumns()
    {
        return [
            ...
            ['name'=>'beginning_date','data'=>'beginning_date','title'=>trans('admin.beginning_date')],
            ['name'=>'end_date','data'=>'end_date','title'=>trans('admin.end_date')],
            ['name'=>'renew_date','data'=>'renew_date','title'=>trans('admin.renew_date')],
            ['name'=>'salary','data'=>'salary','title'=>trans('admin.salary')],
            ['name'=>'payment_methods','data'=>'payment_methods','title'=>trans('admin.payment_methods')],
