...
class AstNutrbusnDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('details', function ($query) {
                return '<a href="AstNutrbusn/'.$query->ID_No.'" class="btn btn-info"><i class="fa fa-search"></i></a>';
            })
            ->addColumn('edit', function ($query) {
                return '<a  href="AstNutrbusn/'.$query->ID_No.'/edit" class="btn btn-success edit"><i class="fa fa-edit"></i></a>';
            })
            ->addColumn('delete', 'admin.AstNutrbusn.btn.delete')
            ->rawColumns([
                'edit',
                'details',
                'delete',
...
//                    ->parameters($this->getBuilderParameters());
                ...
                'buttons' => [
                    [
                        ...
                        'action' => 'function( e, dt, button, config){
                             window.location = "AstNutrbusn/create";
                         }',
                    ],
    ...
    {
        return 'AstNutrbusn_' . date('YmdHis');
    }
}
