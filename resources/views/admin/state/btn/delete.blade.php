...
<a class="btn btn-danger waves-effect waves-light remove-record" data-toggle="modal" data-url="{{ \Illuminate\Support\Facades\URL::route('state.destroy', $id) }}" data-id="{{$id}}" data-target="#custom-width-modal"><i class="fa fa-trash"></i> {{trans('admin.delete')}}</a>
