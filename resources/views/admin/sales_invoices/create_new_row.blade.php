...
{{--            @endforeach--}}
    ...
    <td><input type="text" name="Taxp_Extra" value="5" id="Taxp_Extra_{{$row}}" class="Taxp_Extra"></td>
    <td><input type="text" name="Taxv_Extra" value="0" id="Taxv_Extra_{{$row}}" class="Taxv_Extra"></td>
</tr>
