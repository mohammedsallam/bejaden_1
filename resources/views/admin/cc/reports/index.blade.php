    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div class="col-md-6">
                ...
                {{ Form::select('from_glcc',$glcc,null, array_merge(['class' => 'form-control e2 from_glcc','placeholder'=> trans('admin.select') ])) }}
            </div>
            <div class="col-md-6">
                {{ Form::label('glcc',trans('admin.to_cc'), ['class' => 'control-label']) }}
                {{ Form::select('to_glcc',$glcc,null, array_merge(['class' => 'form-control e3 to_glcc','placeholder'=> trans('admin.select') ])) }}
            </div>
        </div>
