    ...
    <div class="box">
        ...
        <div class="box-body row">
            ...
            <div class="col-xs-4 well">
                ...
                {{ Form::text('From',\Carbon\Carbon::today()->format('Y-'.\Carbon\Carbon::now()->diffInYears(\Carbon\Carbon::now()->copy()->addYear()).'-'.\Carbon\Carbon::now()->diffInYears(\Carbon\Carbon::now()->copy()->addYear())), array_merge(['class' => 'col-xs-4 form-control  hijri-date-input','id'=>'froxsate','autocomplete'=>'off'])) }}

                <br>
                <br>

                {{ Form::label('To', trans('admin.To'), ['class' => 'col-xs-2']) }}
                {{ Form::text('To',\Carbon\Carbon::today()->format('Y-m-d'), array_merge(['class' => 'col-xs-4 form-control  hijri-date-input date','id'=>'toDate'])) }}
