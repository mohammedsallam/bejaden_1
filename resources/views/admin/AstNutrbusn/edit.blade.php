...
@section('content')
    ...
    <form action="{{route('AstNutrbusn.update', $act->ID_No)}}" method="POST">
        {{ csrf_field() }}
        {{ method_field('PUT') }}
        <div class="panel panel-primary" style="width:50%; margin:auto auto;    ">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <input type="text" name="Nutr_No" id="Nutr_No" class="form-control col-md-2" readonly value="{{$act->Nutr_No}}">
                </div>
                {{-- نهاية رقم النشاط --}}
                {{-- اسم الحساب عربى --}}
                <div class="row">
